...
public final class HelloServiceGrpc {
    ...
    public static final String SERVICE_NAME = "com.rumahorbo.grpcunary.HelloService";
    private static final int METHODID_HELLO = 0;
    // Static method descriptors that strictly reflect the proto.
    private static volatile io.grpc.MethodDescriptor<com.rumahorbo.grpcunary.HelloRequest,
            com.rumahorbo.grpcunary.HelloResponse> getHelloMethod;
    ...
    @io.grpc.stub.annotations.RpcMethod(
            ...
            requestType = com.rumahorbo.grpcunary.HelloRequest.class,
            responseType = com.rumahorbo.grpcunary.HelloResponse.class,
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.rumahorbo.grpcunary.HelloRequest,
            com.rumahorbo.grpcunary.HelloResponse> getHelloMethod() {
        io.grpc.MethodDescriptor<com.rumahorbo.grpcunary.HelloRequest, com.rumahorbo.grpcunary.HelloResponse> getHelloMethod;
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
            synchronized (HelloServiceGrpc.class) {
                if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
                    HelloServiceGrpc.getHelloMethod = getHelloMethod =
                            io.grpc.MethodDescriptor.<com.rumahorbo.grpcunary.HelloRequest, com.rumahorbo.grpcunary.HelloResponse>newBuilder()
                                    .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                                    .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
                                    .setSampledToLocalTracing(true)
                                    .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            com.rumahorbo.grpcunary.HelloRequest.getDefaultInstance()))
                                    .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            com.rumahorbo.grpcunary.HelloResponse.getDefaultInstance()))
    ...
    public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
         ...
         *
         */
        public void hello(com.rumahorbo.grpcunary.HelloRequest request,
                          io.grpc.stub.StreamObserver<com.rumahorbo.grpcunary.HelloResponse> responseObserver) {
            ...
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            ...
                            io.grpc.stub.ServerCalls.asyncUnaryCall(
                                    new MethodHandlers<
                                            com.rumahorbo.grpcunary.HelloRequest,
                                            com.rumahorbo.grpcunary.HelloResponse>(
                                            this, METHODID_HELLO)))
                    .build();
        }
    }
    ...
    public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
         ...
         *
         */
        public com.rumahorbo.grpcunary.HelloResponse hello(com.rumahorbo.grpcunary.HelloRequest request) {
    ...
    public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
         ...
         *
         */
        public com.google.common.util.concurrent.ListenableFuture<com.rumahorbo.grpcunary.HelloResponse> hello(
                com.rumahorbo.grpcunary.HelloRequest request) {
    ...
    private static final class MethodHandlers<Req, Resp> implements
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_HELLO:
                    serviceImpl.hello((com.rumahorbo.grpcunary.HelloRequest) request,
                            (io.grpc.stub.StreamObserver<com.rumahorbo.grpcunary.HelloResponse>) responseObserver);
                    break;
                default:
    ...
    private static abstract class HelloServiceBaseDescriptorSupplier
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return com.rumahorbo.grpcunary.Grpc.getDescriptor();
        }
